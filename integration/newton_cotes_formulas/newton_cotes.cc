...
double NewtonCotes::estimate(double x_I, double x_F, double precision, double (*f)(double)){
    int n = 1;
...
double NewtonCotes::calculatePartitions(double x_I, double x_F, int number_of_partitions, double (*f)(double)){
    double I = 0;
